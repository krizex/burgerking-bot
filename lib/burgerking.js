...
TellBurgerKing.prototype.postSurveyCode = function *(surveyUrl, code) {
  ...
  for (var i = 0; i < cnCount; i++) {
    ...
    return yield this.yreq.post(BK_URL + surveyUrl, formdata, {rejectUnauthorized: false});
};
...
TellBurgerKing.prototype.postFormData = function *(surverNextUrl, formdata) {
    return yield this.yreq.post(BK_URL + surverNextUrl, formdata, {rejectUnauthorized: false});
};
